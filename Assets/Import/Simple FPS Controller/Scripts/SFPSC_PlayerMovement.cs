...
public class SFPSC_PlayerMovement : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (isGrounded)
        {
            ...
            rb.AddForce(Physics.gravity * gravityScale * Time.fixedDeltaTime,
                ForceMode.Acceleration); //It has to be FixedUpdate, because it applies force to the rigidbody constantly.
            // Air control
